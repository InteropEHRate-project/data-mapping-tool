...
public class GenericRDFGenerator extends RdfGenerator {
	...
	private void generateRDF(String modelName, String sourceName,String contextName, RDFGeneratorInputWrapper input,
							 InputType dataType,  InputProperties inputTypeParameters, boolean addProvenance,
							 List<KR2RMLRDFWriter> writers, RootStrategy rootStrategy, List<String> tripleMapToKill,
							 List<String> tripleMapToStop, List<String> POMToKill, ServletContextParameterMap contextParameters,
							 Workspace workspace, Worksheet worksheet) throws KarmaException, IOException {
		...
		generateRDF(modelParser, sourceName, input, dataType, inputTypeParameters, addProvenance, writers, rootStrategy,
			tripleMapToKill, tripleMapToStop, POMToKill, contextParameters, workspace, worksheet);
	}
	...
	private void generateRDF(WorksheetR2RMLJenaModelParser modelParser, String sourceName,
							 RDFGeneratorInputWrapper input, InputType dataType,  InputProperties inputTypeParameters,
							 ...
							 ServletContextParameterMap contextParameters, Workspace workspace,
							 Worksheet worksheet) throws KarmaException, IOException {
	...
	public void generateRDF(RDFGeneratorRequest request) throws KarmaException, IOException
	{
		generateRDF(request.getModelName(), request.getSourceName(), request.getContextName(),
				...
				request.getContextParameters(), request.getWorkspace(), request.getWorksheet());
	}
