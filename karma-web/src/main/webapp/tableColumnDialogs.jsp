        ...
        <form class="bs-example bs-example-form" role="form">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="error" id="addColumnError" style="display: none">Please enter a unique column name!
                    </div>
                </div> <!-- /.modal-body -->
        ...
        <form class="bs-example bs-example-form" role="form">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="form-group">
                            <div class="radio">
                                ...
                                <div class="col-sm-6"><input class="form-control" type="text" id="valueSplitNewColName">
                                </div>
                            </div>
                            <div class="radio">
                                <div class="col-sm-5">
                                    <label>
                                        <input type="radio" value="edit" name="splitValuesType"
                                               id="splitValuesTypeEdit">
                    ...
                    <div class="error" style="display: none" id="splitValuesError">Length of the delimter should be 1
                    </div>
                </div> <!-- /.modal-body -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
        ...
        <form class="bs-example bs-example-form" role="form">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="radio">
                            ...
                            <div class="col-sm-6"><input class="form-control" type="text"
                                                         id="pythonTransformNewColumnName"/></div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-1">
                            <button type="button" class="btn btn-default" id="btnPrevCache">&lt;</button>
                        </div>
                        <div class="col-sm-9">
                            <div id="transformCodeEditor"></div>
                        </div>
                        <div class="col-sm-1">
                            <button type="button" class="btn btn-default" id="btnNextCache">&gt;</button>
                        </div>
                    </div>
                    <br/>
                    <div class="form-group">
                    ...
                    <button type="button" class="btn btn-default" id="btnPreview">Preview results for top 5 rows
                    </button>
                    <br>
                    <div id="pyTransformErrorWindow" style="display:none"></div>
                    <table id="pythonPreviewResultsTable" class="table table-striped table-condensed"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="cleaningOverflowDivLarge">
                        <table id="cleaningExamplesTable" class="table table-striped table-condensed"
...
<div class="modal fade" id="extractConceptsDialog" tabindex="-1">
    <div class="modal-dialog">
        <form class="bs-example bs-example-form" role="form">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Extract Concepts</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="extractionConceptsService_URL">URL for Extraction Service</label>
                        <input class="form-control" type="text" id="extractionConceptsService_URL" required>
                    </div>
...
<div class="modal fade" id="extractionConceptsCapabilitiesDialog" tabindex="-1">
    <div class="modal-dialog" style="display:table;">
        <form class="bs-example bs-example-form" role="form">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="userSelectionPipeline">Pipeline Preferences</label>
                        <select class="form-control" type="text" id="userSelectionPipeline"></select>
                    </div>
                    <div class="form-group">
                        <label for="userSelectionPreferences">Concept Preferences</label>
                        <select class="form-control" type="text" id="userSelectionPreferences"></select>
                    </div>
                    <div class="form-group">
                        <label for="userSelectionLocale">Locale for Extracting Concepts</label>
                        <select class="form-control" type="text" id="userSelectionLocale"></select>
                    </div>
                    <label for="rootConceptForm">Root Concept</label>
                    <div class="form-group" id="rootConceptForm">
                        <div class="row" id="rootConceptRow">
                            <div class="col-lg-8 padding-right-0">
                                <input type="text" id="conceptSearch" class="form-control"
                                       placeholder="Search for concept...">
                            </div>
                            <div class="col-lg-2 padding-left-0 padding-right-0">
                                <select class="form-control" type="text" id="locale"></select>
                            </div>
                    ...
                    <label for="linkingTextToConceptForm">Linking Text To Concept</label>
                    <div class="form-group" id="linkingTextToConceptForm">
                        <div class="row" id="linkingTextToConceptRow">
                            <div class="col-lg-4 padding-right-0">
                                <input type="text" id="textForConcept" class="form-control"
                                       placeholder="Text to be linked...">
                            </div><!-- /.col-lg-5 -->
                        ...
                        <div class="row" id="addNewTextToConceptRowButton">
                            <div class="col-lg-12 text-right">
                                <button type="button" id="addNewTextToConcept" class="btn btn-primary btn-xs">Add More
                                </button>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="extractStructurePreferencesDialog" tabindex="-1">
    <div class="modal-dialog" style="display:table;">
        <form class="bs-example bs-example-form" role="form">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Structure Extraction</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="userSelectionPipeline">Pipeline Preferences</label>
                    ...
                    <div class="form-group">
                        <label for="userSelectionLocale">Language</label>
                        <select class="form-control" type="text" id="userSelectionLocale"></select>
                    </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="aggregationNewColumnName"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="aggregationConstructor"
                                   placeholder="method(columnName)">
                        </div>
                    </div>
                    </br>
                    <div class="form-group">
