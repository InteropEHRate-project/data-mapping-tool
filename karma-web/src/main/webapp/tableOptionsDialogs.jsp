...
<div class="modal fade" id="publishEMLDialog" tabindex="-1">
	<div class="modal-dialog">
		<form class="bs-example bs-example-form" role="form">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title">Publish EML</h4>
					<h6 class="modal-title">In order to publish EML we need RDF graph.</h6>
				</div>
				<div class="modal-body">
					<div class="form-group">
						<label for="emlConversionService_URL">URL for RDF to EML Conversion Service</label>
						<input class="form-control" type="text" id="emlConversionService_URL" required>
					</div>

				</div> <!-- /.modal-body -->
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					<button type="submit" class="btn btn-primary" id="newRdf">Create New RDF</button>
					<button type="submit" class="btn btn-primary" id="oldRdf">Use Existing RDF</button>
				</div> <!-- /.modal-footer -->
			</div><!-- /.modal-content -->
		</form>
	</div><!-- /.modal-dialog -->
