var Settings = (function() {
	...
	function PrivateConstructor() {
		...
		function init() {
			...
			$("#displayKnowDiveServicesSettings").on("click", function(e) {
				KnowDiveServicesSettingsDialog.getInstance().show();
			});
...
var KnowDiveServicesSettingsDialog = (function() {
	var instance = null;

	function PrivateConstructor() {
		var dialog = $("#knowdiveServicesSettingsDialog");
		var callback;
		...
		function init() {
			...
			// $('#reset', dialog).on('click', function(e) {
			// 	e.preventDefault();
			// 	resetToDefault(e);
			// });
			...
			dialog.on('show.bs.modal', function(e) {
				hideError();
				$("#scroll_service_url", dialog).val(scroll_service_url);
				$("#eml_service_url", dialog).val(eml_service_url);
				$("#kos_service_url", dialog).val(kos_service_url);
				$("#kg_importer_url", dialog).val(kg_importer_url);
				$("#catalog_base_url", dialog).val(catalog_base_url);
				$("#catalog_instance_api_key", dialog).val(catalog_instance_api_key);
			});
		}
		...
		function saveDialog(e) {
			...
			var new_scroll_service_url = $("#scroll_service_url", dialog).val();
			var new_eml_service_url = $("#eml_service_url", dialog).val();
			var new_kos_service_url = $("#kos_service_url", dialog).val();
			var new_kg_importer_url = $("#kg_importer_url", dialog).val();
			var new_catalog_base_url = $("#catalog_base_url", dialog).val();
			var new_catalog_instance_api_key = $("#catalog_instance_api_key", dialog).val();

			newInfo.push(getParamObject("new_scroll_service_url", new_scroll_service_url, "other"));
			newInfo.push(getParamObject("new_eml_service_url", new_eml_service_url, "other"));
			newInfo.push(getParamObject("new_kos_service_url", new_kos_service_url, "other"));
			newInfo.push(getParamObject("new_kg_importer_url", new_kg_importer_url, "other"));
			newInfo.push(getParamObject("new_catalog_base_url", new_catalog_base_url, "other"));
			newInfo.push(getParamObject("new_catalog_instance_api_key", new_catalog_instance_api_key, "other"));
			newInfo.push(getParamObject("reset_to_default", false, "other"));
			...
			$.ajax({
				...
				complete: function(xhr, textStatus) {
					...
					scroll_service_url = new_scroll_service_url;
					eml_service_url = new_eml_service_url;
					kos_service_url = new_kos_service_url;
					kg_importer_url = new_kg_importer_url;
					catalog_base_url = new_catalog_base_url;
					catalog_instance_api_key = new_catalog_instance_api_key;
				},
