...
var PublishRDFDialog = (function() {
	...
	function PrivateConstructor() {
		...
		var publishEMLDialog = $("#publishEMLDialog");
		var worksheetId;
		...
		function returnFunc(info) {
			var returned = sendRequest(info, info['worksheetId'], function (json) {
				if(publishEMLDialog.data("publishEML")){
					$('#oldRdf', publishEMLDialog).click();
					publishEMLDialog.data("publishEML",false);
				}
			});
		}
