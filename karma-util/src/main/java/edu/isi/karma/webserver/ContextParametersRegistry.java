...
public class ContextParametersRegistry {
	...
	public synchronized void registerByServletContextParameterMap(ServletContextParameterMap map){
		karmaHomeToContextParameters.putIfAbsent(map.getKarmaHome(), map);
	}
}
