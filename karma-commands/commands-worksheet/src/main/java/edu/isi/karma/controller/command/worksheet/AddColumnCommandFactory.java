...
public class AddColumnCommandFactory extends JSONInputCommandFactory {
	...
	/**
	 * an additional method that allow to create command using java objects instead of JSON or HttpServletRequest
	 * for better performance. mainly used form karma backend.
	 * @param model
	 * @param workspace
	 * @param worksheetId
	 * @param hTableId
	 ...
	 * @return
	 */
	public Command createCommand(String model, Workspace workspace, String worksheetId,
								 String hTableId, String hNodeId, String newColumnName,
								 String defaultValue, String selectionId) {
		return new AddColumnCommand(getNewId(workspace), model, worksheetId,
